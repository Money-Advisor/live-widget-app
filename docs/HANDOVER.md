...
**Version 2.9.14**, in production on agents' machines across Drafters, SFM Advisors
and Lead Generation.
...
Versions 2.9.8 through 2.9.14, largely driven by the August 2026 server move and by
